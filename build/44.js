...
var CoreGradesCourseSplitPage = /** @class */ (function () {
    ...
    CoreGradesCourseSplitPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-grades-course-split',template:/*ion-inline-start:"/eduixmobile/zys/newzys/src/core/grades/pages/coursesplit/coursesplit.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ \'core.grades.grades\' | translate }}</ion-title>\n    </ion-navbar>\n</ion-header>\n<core-split-view>\n    <core-grades-course class="core-avoid-header" [courseId]="courseId" [userId]="userId" [gradeId]="gradeId"></core-grades-course>\n</core-split-view>\n\n\n'/*ion-inline-end:"/eduixmobile/zys/newzys/src/core/grades/pages/coursesplit/coursesplit.html"*/,
        }),
