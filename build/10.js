...
var CoreViewerIframePage = /** @class */ (function () {
    ...
    CoreViewerIframePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-viewer-iframe',template:/*ion-inline-start:"/eduixmobile/zys/newzys/src/core/viewer/pages/iframe/iframe.html"*/'<ion-header>\n    <ion-navbar core-back-button>\n        <ion-title>{{ title }}</ion-title>\n    </ion-navbar>\n</ion-header>\n<ion-content>\n    <core-loading [hideUntil]="url">\n        <core-iframe *ngIf="url" [src]="url"></core-iframe>\n    </core-loading>\n</ion-content>\n'/*ion-inline-end:"/eduixmobile/zys/newzys/src/core/viewer/pages/iframe/iframe.html"*/,
        }),
